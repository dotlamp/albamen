 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/b-1.5.6/sl-1.3.0
 *
 * Included libraries:
...
(function (h) {
    ...
    var ab = function (a, b, c, d, e) {
        ...
        } else if ("static.index" == c || "original" == c) {
            c = 0;
    ...
    n.ext = x = {
        buttons: {},
        classes: {},
        build: "bs4/dt-1.10.18/b-1.5.6/sl-1.3.0",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (f) {
    ...
    g.select.init = function (a) {
        ...
        f.fn.dataTable.ext.order["select-checkbox"] = function (b, a) {
            return this.api().column(a, {order: "static.index"}).nodes().map(function (a) {
