(function (e) {
    ...
    p.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5 mr-2", text: function (a) {
            return a.i18n("buttons.copy", "<i class=\"fa fa-copy\"></i> 복사")
    ...
    p.ext.buttons.excelHtml5 = {
        className: "buttons-excel buttons-html5 mr-2",
        available: function () {
            return i.FileReader !== q && (t || i.JSZip) !== q && !H() && x
        },
        text: function (a) {
            return a.i18n("buttons.excel", "<i class=\"fa fa-file-excel\"></i> 엑셀 내려받기")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
    ...
    p.ext.buttons.pdfHtml5 = {
        className: "buttons-pdf buttons-html5 mr-2",
        available: function () {
            return i.FileReader !== q && (s || i.pdfMake)
        },
        text: function (a) {
            return a.i18n("buttons.pdf", "<i class=\"far fa-file-pdf\"></i> PDF 파일로 내려받기")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
